...
Convert(
  ...
  "/workdir/dwm269/totalRNA/spTotal/pyobjs/heart_infection_sc.h5ad", 
  dest = "h5seurat",
  overwrite = TRUE
  )

heart.seu <- LoadH5Seurat("/workdir/dwm269/totalRNA/spTotal/pyobjs/heart_infection_sc_4samples_no_viral_genes.h5seurat")
head(heart.seu)
```
...
```
Load metadata from Mantri et al, bioRxiv, 2021
```{r}
...
Initialize Seurat objects, merge, subset, and add metadata
```{r}
heart.seu <- lapply(
  heart.sc.list,
